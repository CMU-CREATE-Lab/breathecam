class LocationsController < ApplicationController
  ...
  def index
    ...
    subdomain = "breathecam" if subdomain.blank?
    ...
    @image_asset_name = Rails.application.assets["#{@location_id}.png"].nil? ? "default" : @location_id
  end
end
